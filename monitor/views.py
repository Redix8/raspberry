...
def line(request):
    ...
    print(y_data)
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=x_data.index, y=y_data['temp_25'], mode='lines+markers', name='온도',
                 opacity=0.8, marker_color='red'))

    fig.add_trace(go.Scatter(x=x_data.index, y=y_data['humid_25'], mode='lines+markers', name='습도',
                 opacity=0.8, marker_color='green'))

    fig.add_trace(go.Bar(x=x_data.index, y=y_data['rain_25'], name='강수확률',
                 opacity=0.8))
